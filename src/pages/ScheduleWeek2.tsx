...
type SubjectItem = {
  ...
  name: string;
  color: string;
  icon?: string; // มาจาก DB: อาจเป็นชื่อ AntD Icon หรือ URL รูป
};
...
const ScheduleWeek2: React.FC = () => {
  ...
  // คืน events ของวัน-วิชานั้น ๆ (เรียงตามเวลาเริ่ม)
  ...
  // ไอคอนจาก DB: รองรับทั้ง "ชื่อ AntD Icon" และ "URL รูป"
      ...
      <div className="overflow-x-auto rounded-lg">
        <div className="min-w-max border border-gray-300 rounded-lg">
          ...
          <div
            ...
            style={{
              gridTemplateColumns: `120px repeat(${visibleSubjects.length}, 150px)`, // ✅ วัน 120px + วิชา 150px
            }}
          >
